...
exports.googleAuth = async (req, res) => {
  try {
    ...
    // Handle Mock/Demo OAuth for development
    if (code === 'mock-google-code' && process.env.NODE_ENV !== 'production') {
      console.log('🧪 Using Mock Google Auth');
...
exports.githubAuth = async (req, res) => {
  try {
    ...
    let email, name, avatar_url, githubId;

    // Handle Mock/Demo OAuth for development
    if (code === 'mock-github-code' && process.env.NODE_ENV !== 'production') {
      console.log('🧪 Using Mock GitHub Auth');
      ...
      email = userInfo.data.email || `${userInfo.data.login}@github.placeholder`;
    }
    ...
    res
      ...
      .json({
        success: false,
        message: 'GitHub authentication failed: ' + err.message,
      });
  }
};
