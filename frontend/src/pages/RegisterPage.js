...
export default function RegisterPage() {
  const [form, setForm] = useState({ name: '', email: '', password: '', confirmPassword: '', role: 'student', college: '', department: '' });
      ...
      <div className="auth-card fade-up" style={{ maxWidth: 460 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            />
            {errors.name && <span style={{ color: '#ef4444', fontSize: '12px', marginTop: '4px', display: 'block' }}>⚠️ {errors.name}</span>}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.confirmPassword && <span style={{ color: '#ef4444', fontSize: '12px', marginTop: '4px', display: 'block' }}>⚠️ {errors.confirmPassword}</span>}
          </div>
          ...
          <button 
            ...
            style={{ width: '100%', justifyContent: 'center', padding: 14, marginTop: 4, opacity: loading ? 0.7 : 1 }} 
            disabled={loading}
          >
